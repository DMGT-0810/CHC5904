...
if page == '🏠 Introduction':
    ...
    if plant_page == '🌿 Mulberry':
        ...
        st.image('./image/7.png', width=300)
        ...
        st.image('./image/11.png', width=300)
        ...
        st.image('./image/12.png', width=300)
        ...
        st.image('./image/13.png', width=300)
        ...
        st.image('./image/14.png', width=300)
